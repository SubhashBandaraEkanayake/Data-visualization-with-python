...
app.layout = html.Div([
    ...
    html.Div(dcc.Dropdown(
        ...
        value='Select Statistics',
        placeholder='Select Year', style={'textAlign': 'center', 'width': '80%', 'padding': '3px', 'font-size': 20})
    ),
...
def update_output_container(selected_statistics, input_year):
    ...
    # Check for Yearly Statistics.                             
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(exp_data,
                                           ...
                                           names='Vehicle_Type',
                                           title='Total Advertisement Expenditure for each Vehicle Type in the year {}'.format(
                                               input_year))
                             )
